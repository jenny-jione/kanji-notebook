...
function NewWord() {
  ...
  const [newWord, setNewWord] = useState({ word: "", reading: "", meaning: "", korean: "" });
  ...
  const handleAddWord = async () => {
    ...
    setNewWord({ word: "", reading: "", meaning: "", korean: "" });
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <input placeholder="히라가나" value={newWord.reading} onChange={(e) => setNewWord({ ...newWord, reading: e.target.value })} />
